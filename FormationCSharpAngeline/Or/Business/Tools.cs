...
namespace Or.Business
{
    ...
    public static class Tools
    {
        ...
        public static string Label(CodeResultat code)
        {
            string label = "";
            switch (code) {
                case CodeResultat.ErreurPlafond:
                    label = "Plafond maximum autorisé dépassé";
                    break;
                case CodeResultat.ErreurVirementLivret:
                    label = "Virement entre Livret et Courant de cartes différentes impossibles";
                    break;
