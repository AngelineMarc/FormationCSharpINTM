...
namespace Or.Models
{
    public class Carte
    {
        ...
        /// <returns></returns>
        public bool EstEligibleMaximumRetraitHebdomadaire(decimal montant, DateTime dateEffet)
        {
        ...
        /// <param name="Destinataire"></param>
        /// <returns></returns>
        public bool EstOperationAutoriseeContraintesComptes(Compte Expediteur, Compte Destinataire)
        {
